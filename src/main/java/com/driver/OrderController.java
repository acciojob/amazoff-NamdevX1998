...
public class OrderController {
    ...
    public ResponseEntity<String> addPartner(@PathVariable("partnerId") String partnerId){     //("partnerId")
    ...
    public ResponseEntity<List<String>> getOrdersByPartnerId(@PathVariable("partnerId") String partnerId){
        ...
        orders=OrderService.getOrdersByPartnerId((partnerId));   //not understanding
    ...
    @GetMapping("/get-count-of-orders-left-after-given-time/{time}/{partnerId}")      //     /{time}
